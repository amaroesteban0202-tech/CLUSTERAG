...
const CompactMetricBar = ({ label, value, color = "slate", meta, helper }) => {
  ...
  return (
    <div className="min-w-0">
      ...
      {helper ? (
        <p className="mt-1.5 break-words text-[10px] leading-relaxed font-medium text-slate-500 dark:text-slate-400">
          {helper}
        </p>
      ) : null}
    </div>
      ...
      <div className="bg-gradient-to-br from-purple-600 via-indigo-600 to-blue-700 rounded-3xl p-8 md:p-10 text-white shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-purple-100 font-medium text-sm md:text-base max-w-xl leading-relaxed">
            Hoy es <span className="capitalize">{formattedDate}</span>. Tienes{" "}
            <strong className="text-white">{urgentTasks.length}</strong> tareas
            que requieren atención prioritaria. Mantén el ritmo, ya han
            completado {completedTasks} asignaciones en total.
          </p>
        </div>
        <Icon
          name="Sparkles"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-full">
            ...
            <div className="bg-white dark:bg-slate-900 p-6 md:p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm self-start">
              ...
              <div className="hidden">
                ...
                <span className="text-3xl font-black text-purple-600 dark:text-purple-400 w-16 text-right">
                  {compPercent}%
                </span>
              </div>
            </div>
              ...
              urgentTasks.map((t) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="break-words text-sm font-bold leading-tight text-slate-800 dark:text-slate-100 group-hover:text-purple-600 transition-colors">
                      {t.title}
                    </p>
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h3 className="text-lg font-black text-slate-800 dark:text-white mb-1 flex items-center gap-2">
              <Icon name="Trophy" size={20} className="text-yellow-500" /> KPI
              mensual por Account
            </h3>
            <p className="text-xs text-slate-500 dark:text-slate-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
          {managerStats.length === 0 ? (
            <div className="col-span-full">
              <EmptyState
                icon="Users"
                text="No hay Accounts para evaluar aún."
              />
            </div>
          ) : (
            (() => {
              ...
              if (!hasEnoughTasks) {
                ...
                medalBg =
                  "bg-slate-50 dark:bg-slate-500/10 ring-2 ring-slate-300/50";
              } else if (isThird) {
                medalColor = "text-amber-600";
                medalBg =
                  "bg-amber-50 dark:bg-amber-600/10 ring-2 ring-amber-600/50";
              }
                  ...
                  <div className="grid grid-cols-2 gap-3 rounded-2xl border border-slate-200/80 bg-white/70 p-3 dark:border-slate-800/80 dark:bg-slate-900/40">
                    <div className="min-w-0">
                      ...
                      <p className="mt-1 text-base font-black text-slate-900 dark:text-white">
                        {ms.completedTasks}/{ms.totalTasks}
                      </p>
        ...
        <div className="px-6 py-4 flex flex-wrap gap-2.5">
          ...
          <div className="relative" data-ctdrop>
            ...
            >
              {assignee ? (
                <>
                  <div className="w-4 h-4 rounded-full bg-gradient-to-tr from-purple-500 to-indigo-500 flex items-center justify-center text-white font-black text-[8px]">
