...
var getManagerLinkedUserMatches = (manager = {}, users = []) => {
  ...
  const linkedMatches = users.filter((user) => manager.id && user.linkedManagerId === manager.id);
...
var buildManagerRankingStats = ({ managers = [], users = [], clients = [], accountTasks = [], rankingSettings = DEFAULT_RANKING_SETTINGS, rankingPeriod = getRankingMonthPeriod() }) => {
  ...
  const rankingManagers = managers.filter((manager) => !isManagerLinkedToInactiveUser(manager, users));
...
var LoginScreen = ({ onGoogleSignIn, isSigningIn, email, onEmailChange, onEmailSubmit, isSendingLoginLink }) => /* @__PURE__ */ React.createElement("div", { className: "min-h-screen bg-[#050713] text-white font-sans" }, /* @__PURE__ */ React.createElement("header", { className: "flex min-h-[72px] items-center border-b border-white/10 px-6 sm:px-10 lg:px-16" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2.5" }, /* @__PURE__ */ React.createElement(AgencyLogo, { className: "h-8 w-8 rounded-md text-sm shadow-lg shadow-violet-950/40" }), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "text-base font-black leading-none text-white" }, "CLUSTER"), /* @__PURE__ */ React.createElement("p", { className: "mt-0.5 text-[9px] font-bold uppercase text-slate-500" }, "Agency OS")))), /* @__PURE__ */ React.createElement("main", { className: "flex min-h-[calc(100vh-72px)] items-start justify-center px-5 pb-12 pt-16 sm:pt-20" }, /* @__PURE__ */ React.createElement("section", { className: "w-full max-w-[380px]", "aria-labelledby": "login-title" }, /* @__PURE__ */ React.createElement("div", { className: "mb-7" }, /* @__PURE__ */ React.createElement("h1", { id: "login-title", className: "text-[34px] font-semibold leading-tight tracking-normal text-white" }, "Login"), /* @__PURE__ */ React.createElement("p", { className: "mt-2 text-sm font-medium text-slate-400" }, "Hola, bienvenido")), /* @__PURE__ */ React.createElement(
  ...
  isSigningIn ? /* @__PURE__ */ React.createElement(Icon, { name: "Loader2", size: 17, className: "animate-spin" }) : /* @__PURE__ */ React.createElement("span", { className: "text-base font-black text-blue-600", "aria-hidden": "true" }, "G"),
  "Login with Google"
), /* @__PURE__ */ React.createElement("div", { className: "my-6 flex items-center gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "h-px flex-1 bg-white/10" }), /* @__PURE__ */ React.createElement("span", { className: "text-xs font-medium text-slate-500" }, "or Login with Email"), /* @__PURE__ */ React.createElement("div", { className: "h-px flex-1 bg-white/10" })), /* @__PURE__ */ React.createElement("form", { onSubmit: onEmailSubmit, className: "space-y-4" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { htmlFor: "login-email", className: "mb-2 block text-sm font-medium text-white" }, "Email"), /* @__PURE__ */ React.createElement(
  "input",
  {
    id: "login-email",
    type: "email",
...
var DashboardView = ({ clients, managers, users = [], events, tasks, accountTasks, managementTasks = [], currentUserProfile, onSignIn, rankingSettings = DEFAULT_RANKING_SETTINGS }) => {
  ...
  const managerStats = buildManagerRankingStats({ managers, users, clients, accountTasks, rankingSettings, rankingPeriod });
...
var CalendarGrid = ({ events, onAdd, onEventClick, baseColor = "emerald", canAdd = true }) => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center p-4 border-b border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900" }, /* @__PURE__ */ React.createElement("div", { className: `font-bold uppercase text-xs tracking-widest text-slate-500 dark:text-slate-400` }, "Vista Mensual"), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-4 bg-slate-50 dark:bg-slate-800 rounded-lg p-1" }, /* @__PURE__ */ React.createElement("button", { onClick: () => setDate(new Date(date.getFullYear(), date.getMonth() - 1, 1)), "aria-label": "Mes anterior", className: "p-3 md:p-2 hover:bg-white dark:hover:bg-slate-700 rounded-md text-slate-500 dark:text-slate-300 shadow-sm" }, /* @__PURE__ */ React.createElement(Icon, { name: "ChevronLeft", size: 16 })), /* @__PURE__ */ React.createElement("span", { className: "font-black text-slate-700 dark:text-slate-200 w-32 text-center text-sm uppercase" }, MONTH_NAMES[date.getMonth()], " ", date.getFullYear()), /* @__PURE__ */ React.createElement("button", { onClick: () => setDate(new Date(date.getFullYear(), date.getMonth() + 1, 1)), "aria-label": "Mes siguiente", className: "p-3 md:p-2 hover:bg-white dark:hover:bg-slate-700 rounded-md text-slate-500 dark:text-slate-300 shadow-sm" }, /* @__PURE__ */ React.createElement(Icon, { name: "ChevronRight", size: 16 })))), /* @__PURE__ */ React.createElement("div", { className: "flex-1 overflow-x-auto overflow-y-auto bg-slate-50 dark:bg-slate-950 custom-scroll" }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-7 auto-rows-fr min-w-[800px] h-full" }, ["D", "L", "M", "M", "J", "V", "S"].map((d) => /* @__PURE__ */ React.createElement("div", { key: d, className: "py-2 text-center text-[10px] font-black text-slate-500 dark:text-slate-400 border-r border-b border-slate-200/50 dark:border-slate-800 bg-white dark:bg-slate-900 sticky top-0 z-10" }, d)), Array(startDay).fill(null).map((_, i) => /* @__PURE__ */ React.createElement("div", { key: `empty-${i}`, className: "border-r border-b border-slate-200/50 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/30" })), Array.from({ length: daysInMonth }, (_, i) => i + 1).map((d) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { key: d, onClick: () => {
      if (canAdd) onAdd(dStr);
    }, className: `border-r border-b border-slate-200/60 dark:border-slate-800 bg-white dark:bg-slate-900 p-2 min-h-[120px] hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group relative ${canAdd ? "cursor-pointer" : "cursor-default"}` }, /* @__PURE__ */ React.createElement("span", { className: `text-xs font-bold text-slate-500 dark:text-slate-400 group-hover:text-purple-500 dark:group-hover:text-purple-400` }, d), /* @__PURE__ */ React.createElement("div", { className: "mt-2 space-y-1.5" }, dayEvents.map((e) => {
    ...
    })), canAdd && /* @__PURE__ */ React.createElement(Icon, { name: "Plus", className: `absolute bottom-2 right-2 text-slate-300 dark:text-slate-600 opacity-0 group-hover:opacity-100 transition-opacity`, size: 16 }));
  }))));
};
...
var TaskDetailModal = ({ config, onClose, clients, managers, editors, users, canEdit, onEdit, onChangeStatus, onAddComment, onAddTimeEntry, onUpdateChecklist, onChangePriority, onChangeAssignee, onChangeAssignees, sendNotification, onAddAttachment, onRemoveAttachment, onDelete, currentUserProfile, accountTasks = [], editingTasks = [], managementTasks = [] }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "fixed inset-0 z-[80] bg-slate-950/70 dark:bg-black/80 backdrop-blur-sm flex items-center justify-center p-3 md:p-6 overflow-y-auto", onClick: onClose }, /* @__PURE__ */ React.createElement("div", { ref: dialogRef, role: "dialog", "aria-modal": "true", "aria-labelledby": dialogTitleId, tabIndex: -1, className: "bg-white dark:bg-slate-950 rounded-2xl shadow-2xl w-full max-w-6xl flex flex-col border border-slate-200 dark:border-slate-800 overflow-hidden outline-none", style: { maxHeight: "92vh" }, onClick: function(e) {
    e.stopPropagation();
  } }, /* @__PURE__ */ React.createElement("div", { className: "min-h-[56px] border-b border-slate-200 dark:border-slate-800 flex items-center px-4 md:px-5 gap-2 shrink-0 bg-white/95 dark:bg-slate-950/95" }, /* @__PURE__ */ React.createElement("div", { className: `flex items-center gap-1.5 px-2 py-0.5 rounded text-[11px] font-black uppercase tracking-wide bg-${tagColor}-100 dark:bg-${tagColor}-500/20 text-${tagColor}-700 dark:text-${tagColor}-400` }, /* @__PURE__ */ React.createElement(Icon, { name: iconName, size: 11 }), typeLabel), /* @__PURE__ */ React.createElement(Icon, { name: "ChevronRight", size: 12, className: "text-slate-300 dark:text-slate-600" }), /* @__PURE__ */ React.createElement("span", { className: "text-xs text-slate-500 font-mono" }, task.id?.slice(0, 8)), /* @__PURE__ */ React.createElement("div", { className: "flex-1" }), canAct && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("button", { onClick: () => onEdit(task, type), "aria-label": `Editar ${task.title || "tarea"}`, title: "Editar", className: "min-h-[40px] flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold rounded-lg border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors" }, /* @__PURE__ */ React.createElement(Icon, { name: "Pencil", size: 11 }), " ", /* @__PURE__ */ React.createElement("span", { className: "hidden sm:inline" }, "Editar")), /* @__PURE__ */ React.createElement("button", { onClick: () => onDelete(task, type), "aria-label": `Eliminar ${task.title || "tarea"}`, title: "Eliminar", className: "min-h-[40px] flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold rounded-lg text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors" }, /* @__PURE__ */ React.createElement(Icon, { name: "Trash2", size: 11 }), " ", /* @__PURE__ */ React.createElement("span", { className: "hidden sm:inline" }, "Eliminar"))), /* @__PURE__ */ React.createElement("button", { onClick: onClose, "aria-label": "Cerrar modal", className: "ml-1 min-h-[40px] min-w-[40px] flex items-center justify-center rounded-lg text-slate-500 hover:text-slate-800 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-900 transition-colors" }, /* @__PURE__ */ React.createElement(Icon, { name: "X", size: 16 }))), /* @__PURE__ */ React.createElement("div", { className: "flex-1 flex flex-col lg:flex-row overflow-hidden min-h-0" }, /* @__PURE__ */ React.createElement("div", { className: "flex-1 min-w-0 overflow-y-auto custom-scroll bg-white dark:bg-slate-950" }, /* @__PURE__ */ React.createElement("div", { className: "max-w-3xl mx-auto px-5 md:px-8 pt-6 md:pt-7 pb-10" }, /* @__PURE__ */ React.createElement("h1", { id: dialogTitleId, className: "text-xl md:text-[24px] font-black text-slate-900 dark:text-white leading-snug mb-4 pr-4 break-words" }, task.title), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-3 mb-6", "data-dropdown": true }, /* @__PURE__ */ React.createElement("div", { className: "relative" }, /* @__PURE__ */ React.createElement(
    "button",
    {
  ...
  )))), task.createdAt && /* @__PURE__ */ React.createElement("span", { className: "text-xs text-slate-500 dark:text-slate-400 flex items-center gap-1" }, /* @__PURE__ */ React.createElement(Icon, { name: "Clock", size: 11 }), "Creado el ", new Date(task.createdAt).toLocaleDateString("es-ES", { day: "numeric", month: "short" }), " a las ", new Date(task.createdAt).toLocaleTimeString("es-ES", { hour: "2-digit", minute: "2-digit" }))), /* @__PURE__ */ React.createElement("div", { className: "mb-7" }, /* @__PURE__ */ React.createElement("p", { className: "text-[11px] font-black uppercase tracking-[0.16em] text-slate-500 dark:text-slate-400 mb-2" }, "Descripci\xF3n"), task.notes ? /* @__PURE__ */ React.createElement("div", { className: "rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50/70 dark:bg-slate-900/70 px-4 py-3" }, /* @__PURE__ */ React.createElement("p", { className: "text-sm text-slate-700 dark:text-slate-300 whitespace-pre-wrap leading-relaxed" }, task.notes)) : /* @__PURE__ */ React.createElement(
    "button",
    {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "mb-7" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 mb-3" }, /* @__PURE__ */ React.createElement(Icon, { name: "CheckSquare", size: 13, className: "text-slate-500" }), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] font-black uppercase tracking-[0.16em] text-slate-500 dark:text-slate-400" }, "Lista de control"), checklist.length > 0 && /* @__PURE__ */ React.createElement("span", { className: "text-xs text-slate-500 ml-1" }, done, "/", checklist.length), checklist.length > 0 && /* @__PURE__ */ React.createElement("span", { className: "ml-auto text-xs font-bold text-slate-500" }, pct, "%")), checklist.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "h-1.5 bg-slate-100 dark:bg-slate-800 rounded-full mb-3 overflow-hidden" }, /* @__PURE__ */ React.createElement("div", { className: "h-full bg-emerald-500 rounded-full transition-all duration-500", style: { width: `${pct}%` } })), /* @__PURE__ */ React.createElement("div", { className: "space-y-0.5" }, checklist.map((item) => /* @__PURE__ */ React.createElement("div", { key: item.id, className: "flex items-center gap-3 group py-2 px-3 rounded-xl border border-transparent hover:border-slate-200 dark:hover:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-900/70 transition-colors" }, /* @__PURE__ */ React.createElement(
      "button",
      {
  ...
  })(), /* @__PURE__ */ React.createElement("div", { className: "border-t border-slate-100 dark:border-slate-800 pt-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 mb-5" }, /* @__PURE__ */ React.createElement(Icon, { name: "MessageSquare", size: 13, className: "text-slate-500" }), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] font-black uppercase tracking-[0.16em] text-slate-500 dark:text-slate-400" }, "Actividad"), totalLoggedMs > 0 && /* @__PURE__ */ React.createElement("span", { className: "ml-auto text-xs font-bold text-emerald-600 dark:text-emerald-400 flex items-center gap-1" }, /* @__PURE__ */ React.createElement(Icon, { name: "Clock", size: 11 }), formatDuration(totalLoggedMs))), /* @__PURE__ */ React.createElement("div", { className: "flex gap-3 mb-6" }, /* @__PURE__ */ React.createElement("div", { className: "w-8 h-8 rounded-full bg-gradient-to-tr from-purple-500 to-indigo-500 flex items-center justify-center text-white font-black text-[10px] shrink-0" }, (currentUserProfile?.name || "U").slice(0, 2).toUpperCase()), /* @__PURE__ */ React.createElement("div", { className: "flex-1 relative" }, /* @__PURE__ */ React.createElement(
    "textarea",
    {
      ref: commentInputRef,
      value: commentText,
