...
var Icon = ({ name, size = 18, className = "", ...props }) => {
  ...
  return LucideIcon ? /* @__PURE__ */ React.createElement(
    LucideIcon,
    {
      size,
      className,
...
var AgencyLogo = ({ className }) => {
  return /* @__PURE__ */ React.createElement(
    "div",
    {
      className: `bg-purple-600 flex items-center justify-center text-white font-black rounded-lg ${className}`
    },
    "C"
  );
};
...
function App() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "flex h-screen text-slate-900 dark:text-slate-100 overflow-hidden flex-col md:flex-row font-sans transition-colors duration-300" }, /* @__PURE__ */ React.createElement("div", { className: "md:hidden bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 p-4 flex justify-between items-center z-30 shadow-sm shrink-0" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement(AgencyLogo, { className: "w-8 h-8 text-sm" }), /* @__PURE__ */ React.createElement("span", { className: "font-black text-slate-800 dark:text-white text-lg" }, "CLUSTER")), /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      canAccessView(currentUserProfile, "managers") && /* @__PURE__ */ React.createElement(
        SidebarItem,
        {
          active: view === "managers" || view === "manager-detail",
      ...
      canAccessView(currentUserProfile, "editors") && /* @__PURE__ */ React.createElement(
        SidebarItem,
        {
          active: view === "editors" || view === "editor-detail",
      ...
      canAccessView(currentUserProfile, "general-calendar") && /* @__PURE__ */ React.createElement(
        SidebarItem,
        {
          active: view === "general-calendar",
          onClick: () => handleNavigate("general-calendar"),
          icon: "CalendarDays",
          label: "Calendario General",
          color: "blue"
        }
      ),
      canAccessView(currentUserProfile, "calendar") && /* @__PURE__ */ React.createElement(
        SidebarItem,
        {
          active: view === "calendar",
          onClick: () => handleNavigate("calendar"),
          icon: "CalendarIcon",
          label: "Agenda Producci\xF3n",
          color: "emerald"
        }
      ),
  ...
  ), /* @__PURE__ */ React.createElement("main", { className: "flex-1 overflow-y-auto relative w-full h-full" }, /* @__PURE__ */ React.createElement("div", { className: "p-4 md:p-8 max-w-[1600px] mx-auto min-h-full pb-mobile-nav md:pb-20" }, view === "dashboard" && (isFirstTimeWorkspace ? /* @__PURE__ */ React.createElement(
    FirstTimeView,
    {
  ...
  ), view === "managers" && /* @__PURE__ */ React.createElement(
    TeamView,
    {
  ...
  ), view === "editors" && /* @__PURE__ */ React.createElement(
    TeamView,
    {
      title: "Editores",
      team: editors,
...
var Button = ({
  ...
  "button",
  {
    type,
    onClick,
    className: `${full ? "w-full" : ""} min-h-[46px] whitespace-nowrap bg-${color}-600 hover:bg-${color}-700 text-white px-5 py-2.5 rounded-xl font-bold shadow-lg shadow-${color}-500/30 flex items-center justify-center gap-2 transition-all transform active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-${color}-500 dark:focus-visible:ring-offset-slate-950`,
    ...props
  },
...
var EmptyState = ({ icon, text }) => /* @__PURE__ */ React.createElement("div", { className: "flex flex-col items-center justify-center p-6 text-center h-full opacity-60" }, /* @__PURE__ */ React.createElement(
  Icon,
  {
    name: icon,
    size: 32,
...
), /* @__PURE__ */ React.createElement("p", { className: "text-sm font-bold text-slate-500 dark:text-slate-400" }, text));
...
var LoginScreen = ({
  ...
  onEmailSubmit,
  isSendingLoginLink
}) => /* @__PURE__ */ React.createElement("div", { className: "min-h-screen bg-[#050713] text-white font-sans" }, /* @__PURE__ */ React.createElement("header", { className: "flex min-h-[72px] items-center border-b border-white/10 px-6 sm:px-10 lg:px-16" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2.5" }, /* @__PURE__ */ React.createElement(AgencyLogo, { className: "h-8 w-8 rounded-md text-sm shadow-lg shadow-violet-950/40" }), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "text-base font-black leading-none text-white" }, "CLUSTER"), /* @__PURE__ */ React.createElement("p", { className: "mt-0.5 text-[9px] font-bold uppercase text-slate-500" }, "Agency OS")))), /* @__PURE__ */ React.createElement("main", { className: "flex min-h-[calc(100vh-72px)] items-start justify-center px-5 pb-12 pt-16 sm:pt-20" }, /* @__PURE__ */ React.createElement("section", { className: "w-full max-w-[380px]", "aria-labelledby": "login-title" }, /* @__PURE__ */ React.createElement("div", { className: "mb-7" }, /* @__PURE__ */ React.createElement(
  "h1",
  {
    id: "login-title",
  ...
  "Login"
), /* @__PURE__ */ React.createElement("p", { className: "mt-2 text-sm font-medium text-slate-400" }, "Hola, bienvenido")), /* @__PURE__ */ React.createElement(
  "button",
  {
  ...
  isSigningIn ? /* @__PURE__ */ React.createElement(Icon, { name: "Loader2", size: 17, className: "animate-spin" }) : /* @__PURE__ */ React.createElement(
    "span",
    {
  ...
  "Login with Google"
), /* @__PURE__ */ React.createElement("div", { className: "my-6 flex items-center gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "h-px flex-1 bg-white/10" }), /* @__PURE__ */ React.createElement("span", { className: "text-xs font-medium text-slate-500" }, "or Login with Email"), /* @__PURE__ */ React.createElement("div", { className: "h-px flex-1 bg-white/10" })), /* @__PURE__ */ React.createElement("form", { onSubmit: onEmailSubmit, className: "space-y-4" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(
  "label",
  {
    htmlFor: "login-email",
...
)), /* @__PURE__ */ React.createElement("p", { className: "mt-6 text-center text-sm font-medium text-slate-500" }, "Acceso solo con cuenta autorizada."))));
...
var StatCard = ({ title, value, icon, color }) => /* @__PURE__ */ React.createElement("div", { className: "bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm flex items-center justify-between hover:shadow-md transition-shadow" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1" }, title), /* @__PURE__ */ React.createElement("p", { className: "text-3xl font-black text-slate-800 dark:text-white" }, value)), /* @__PURE__ */ React.createElement(
  "div",
  {
    className: `p-3 rounded-xl bg-${color}-50 dark:bg-${color}-500/20 text-${color}-600 dark:text-${color}-400`
  },
  /* @__PURE__ */ React.createElement(Icon, { name: icon, size: 24 })
));
var Input = ({ label, id, className = "", ...props }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", null, label && /* @__PURE__ */ React.createElement(
    ...
    {
      htmlFor: inputId,
      className: "block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase mb-1.5 ml-1"
    },
    label
  ), /* @__PURE__ */ React.createElement(
    "input",
...
var CompactMetricBar = ({ label, value, color = "slate", meta, helper }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "min-w-0" }, /* @__PURE__ */ React.createElement("div", { className: "mb-1.5 flex items-start justify-between gap-3" }, /* @__PURE__ */ React.createElement("span", { className: "min-w-0 text-[10px] font-black uppercase tracking-[0.14em] text-slate-500 dark:text-slate-400" }, label), /* @__PURE__ */ React.createElement(
    ...
    meta || `${Math.round(safeValue)}%`
  )), /* @__PURE__ */ React.createElement("div", { className: "h-2 rounded-full overflow-hidden bg-slate-200 dark:bg-slate-800" }, /* @__PURE__ */ React.createElement(
    "div",
    {
      className: "h-full rounded-full transition-all duration-700",
      style: {
        width: `${safeValue}%`,
        background: `linear-gradient(90deg, ${palette.solid}, ${palette.strong})`
      }
    }
  )), helper ? /* @__PURE__ */ React.createElement("p", { className: "mt-1.5 break-words text-[10px] leading-relaxed font-medium text-slate-500 dark:text-slate-400" }, helper) : null);
};
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "mt-2 h-2.5 rounded-full overflow-hidden bg-slate-200 dark:bg-slate-800" }, /* @__PURE__ */ React.createElement(
        "div",
        {
          ...
          style: {
            width: `${percent}%`,
            background: `linear-gradient(90deg, ${segment.color}, ${segment.strong})`
          }
        }
      ))
    );
...
var ProgressOverviewChart = ({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "mt-5 grid grid-cols-1 gap-5" }, /* @__PURE__ */ React.createElement("div", { className: "relative mx-auto h-44 w-44" }, /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 220 220", className: "h-full w-full -rotate-90" }, /* @__PURE__ */ React.createElement("defs", null, /* @__PURE__ */ React.createElement(
    "linearGradient",
    {
      id: "dashboard-progress-gradient",
      x1: "0%",
      y1: "0%",
      x2: "100%",
      y2: "100%"
    },
    /* @__PURE__ */ React.createElement("stop", { offset: "0%", stopColor: "#8b5cf6" }),
    /* @__PURE__ */ React.createElement("stop", { offset: "55%", stopColor: "#3b82f6" }),
    /* @__PURE__ */ React.createElement("stop", { offset: "100%", stopColor: "#06b6d4" })
  )), /* @__PURE__ */ React.createElement(
    "circle",
    {
      cx: "110",
...
var DashboardView = ({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "space-y-6 animate-in fade-in duration-500" }, /* @__PURE__ */ React.createElement("div", { className: "bg-gradient-to-br from-purple-600 via-indigo-600 to-blue-700 rounded-3xl p-8 md:p-10 text-white shadow-xl relative overflow-hidden" }, /* @__PURE__ */ React.createElement("div", { className: "absolute top-0 right-0 w-64 h-64 bg-white opacity-5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3" }), /* @__PURE__ */ React.createElement("div", { className: "absolute bottom-0 right-1/4 w-40 h-40 bg-purple-400 opacity-20 rounded-full blur-2xl translate-y-1/3" }), /* @__PURE__ */ React.createElement("div", { className: "relative z-10" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 mb-2" }, /* @__PURE__ */ React.createElement("span", { className: "px-3 py-1 bg-white/20 rounded-full text-[10px] font-black uppercase tracking-widest backdrop-blur-md border border-white/10" }, "Resumen Operativo")), /* @__PURE__ */ React.createElement("h2", { className: "text-3xl md:text-4xl font-black mb-2 tracking-tight" }, "\xA1Hola, Equipo Cluster! \u{1F44B}"), /* @__PURE__ */ React.createElement("p", { className: "text-purple-100 font-medium text-sm md:text-base max-w-xl leading-relaxed" }, "Hoy es ", /* @__PURE__ */ React.createElement("span", { className: "capitalize" }, formattedDate), ". Tienes", " ", /* @__PURE__ */ React.createElement("strong", { className: "text-white" }, urgentTasks.length), " tareas que requieren atenci\xF3n prioritaria. Mant\xE9n el ritmo, ya han completado ", completedTasks, " asignaciones en total.")), /* @__PURE__ */ React.createElement(
    Icon,
    {
      name: "Sparkles",
      size: 140,
      className: "absolute -right-8 -top-8 text-white opacity-10 rotate-12"
    }
  )), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6" }, /* @__PURE__ */ React.createElement(
    StatCard,
    {
    ...
    return managerStats.map((ms) => {
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-start gap-3 min-w-0" }, /* @__PURE__ */ React.createElement("div", { className: "flex min-w-0 flex-1 items-center gap-3" }, /* @__PURE__ */ React.createElement(
          "div",
          {
        ...
        )), /* @__PURE__ */ React.createElement("p", { className: "break-words text-[10px] leading-relaxed text-slate-500 font-medium" }, ms.completedTasks, "/", ms.totalTasks, " tareas del mes |", " ", ms.totalClients, " clientes"), !hasEnoughTasks && /* @__PURE__ */ React.createElement("span", { className: "inline-block mt-0.5 text-[9px] font-black uppercase tracking-wider text-slate-400 bg-slate-100 dark:bg-slate-800 dark:text-slate-500 rounded px-1.5 py-0.5" }, "Datos insuficientes"))), /* @__PURE__ */ React.createElement("div", { className: "text-right shrink-0" }, /* @__PURE__ */ React.createElement("p", { className: "text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400" }, "KPI"), /* @__PURE__ */ React.createElement(
          "span",
          {
...
var DateHeader = ({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "flex flex-col 2xl:flex-row justify-between items-start 2xl:items-center gap-4 bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col lg:flex-row lg:flex-wrap items-start lg:items-center gap-4 w-full min-w-0 2xl:w-auto" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3 shrink-0" }, /* @__PURE__ */ React.createElement(
    Icon,
    {
      name: "LayoutList",
  ...
  ), /* @__PURE__ */ React.createElement("h2", { className: "text-xl font-black text-slate-800 dark:text-white" }, title)), /* @__PURE__ */ React.createElement("div", { className: "flex flex-col lg:flex-row lg:flex-wrap gap-3 w-full min-w-0 lg:w-auto" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-0.5" }, /* @__PURE__ */ React.createElement("span", { className: "text-[9px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 px-1" }, "Fecha"), /* @__PURE__ */ React.createElement("div", { className: "flex bg-slate-100 dark:bg-slate-800 p-1 rounded-xl w-full sm:w-auto max-w-full overflow-x-auto custom-scroll" }, /* @__PURE__ */ React.createElement(
    "button",
    {
    ...
    "Todas las fechas"
  ))), setOwnershipFilter && /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-0.5" }, /* @__PURE__ */ React.createElement("span", { className: "text-[9px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 px-1" }, "Asignaci\xF3n"), /* @__PURE__ */ React.createElement("div", { className: "flex bg-slate-100 dark:bg-slate-800 p-1 rounded-xl w-full sm:w-auto max-w-full overflow-x-auto custom-scroll" }, /* @__PURE__ */ React.createElement(
    "button",
    {
    ...
    "Asignadas a m\xED"
  )))), filterMode === "date" && /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 w-full sm:w-auto" }, /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "date",
      value: currentDate,
  ...
  ), currentDate === today && /* @__PURE__ */ React.createElement("span", { className: "text-[10px] bg-blue-100 dark:bg-blue-500/20 text-blue-700 dark:text-blue-400 font-bold px-2 py-1 rounded-full shrink-0" }, "Hoy")), filterMode === "range" && hasRangeSupport && /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 w-full sm:w-auto flex-wrap" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-xs font-bold text-slate-500 dark:text-slate-400 shrink-0" }, "Desde"), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "date",
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-xs font-bold text-slate-500 dark:text-slate-400 shrink-0" }, "Hasta"), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "date",
  ...
  )))), /* @__PURE__ */ React.createElement("div", { className: "flex flex-col sm:flex-row sm:flex-wrap w-full 2xl:w-auto gap-3 items-stretch sm:items-center" }, /* @__PURE__ */ React.createElement(
    SearchBar,
    {
      searchTerm,
      setSearchTerm,
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "w-full sm:w-auto shrink-0" }, /* @__PURE__ */ React.createElement(
    Button,
    {
      onClick: () => onAdd(
...
var AccountRoomView = ({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "h-full flex flex-col space-y-6 fade-in" }, /* @__PURE__ */ React.createElement(
  ...
  ), false, /* @__PURE__ */ React.createElement("div", { className: "flex-1 flex md:grid md:grid-cols-4 gap-4 overflow-x-auto md:overflow-hidden pb-4 md:pb-0 snap-x snap-mandatory kanban-mobile-scroll -mx-4 px-4 md:mx-0 md:px-0 min-h-0" }, columns.map((col, colIndex) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("span", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement(Icon, { name: col.icon, size: 13 }), col.title),
        " ",
        /* @__PURE__ */ React.createElement("span", { className: "bg-white dark:bg-slate-900 px-2 py-0.5 rounded-full text-slate-500 dark:text-slate-400 shadow-sm" }, colTasks.length)
      ),
      /* @__PURE__ */ React.createElement("div", { className: "p-3 flex-1 overflow-y-auto space-y-3 custom-scroll" }, colTasks.length === 0 ? /* @__PURE__ */ React.createElement(EmptyState, { icon: "Inbox", text: "Vac\xEDo" }) : colTasks.map((t) => {
        ...
        return /* @__PURE__ */ React.createElement(
          ...
          )), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity" }, /* @__PURE__ */ React.createElement(
            "button",
            {
              onClick: (e) => {
                e.stopPropagation();
          ...
          isOverdue && /* @__PURE__ */ React.createElement("div", { className: "absolute bottom-11 right-2 flex items-center gap-1 text-[9px] font-black text-red-500 bg-red-50 dark:bg-red-900/50 px-1.5 py-0.5 rounded border border-red-200 dark:border-red-800" }, "Atrasado", " ", /* @__PURE__ */ React.createElement(
            Icon,
            {
              name: "Flame",
              size: 10,
          ...
          /* @__PURE__ */ React.createElement("div", { className: "flex gap-1.5 mt-4 pt-3 border-t border-slate-100 dark:border-slate-800" }, prevStatus && /* @__PURE__ */ React.createElement(
            "button",
            {
              onClick: (e) => {
                e.stopPropagation();
            ...
            /* @__PURE__ */ React.createElement(Icon, { name: "ChevronLeft", size: 12 }),
            " Volver a",
            " ",
            prevLabel
          ), nextStatus && /* @__PURE__ */ React.createElement(
            "button",
            {
              onClick: (e) => {
                e.stopPropagation();
            ...
            nextStatus === "publicado" ? "Publicar" : "Avanzar",
            " ",
            /* @__PURE__ */ React.createElement(
              Icon,
              {
                name: nextStatus === "publicado" ? "CheckCircle2" : "ChevronRight",
                size: 12
              }
            )
          ))
...
var EditionsRoomView = ({
  ...
  const rankingMap = rankedTasks2.reduce(
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "flex-1 flex md:grid md:grid-cols-5 gap-4 overflow-x-auto md:overflow-hidden pb-4 md:pb-0 snap-x snap-mandatory kanban-mobile-scroll -mx-4 px-4 md:mx-0 md:px-0 min-h-0" }, columns.map((col, colIndex) => {
    const colTasks = filteredTasks.filter((t) => t.status === col.id);
    const prevStatus = colIndex > 0 ? columns[colIndex - 1].id : null;
    const nextStatus = colIndex < columns.length - 1 ? columns[colIndex + 1].id : null;
    const prevLabel = colIndex > 0 ? columns[colIndex - 1].title : "";
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "p-3 flex-1 overflow-y-auto space-y-3 custom-scroll" }, colTasks.length === 0 ? /* @__PURE__ */ React.createElement(EmptyState, { icon: "Inbox", text: "Vac\xEDo" }) : colTasks.map((t) => {
        ...
        return /* @__PURE__ */ React.createElement(
          ...
          ))), canManageEditingTasks && /* @__PURE__ */ React.createElement("div", { className: "flex gap-2 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity" }, /* @__PURE__ */ React.createElement(
            "button",
            {
              onClick: (e) => {
                e.stopPropagation();
          ...
          isOverdue && /* @__PURE__ */ React.createElement("div", { className: "absolute bottom-12 right-2 flex items-center gap-1 text-[9px] font-black text-red-500 bg-red-50 dark:bg-red-900/50 px-1.5 py-0.5 rounded border border-red-200 dark:border-red-800" }, "Atrasado", " ", /* @__PURE__ */ React.createElement(
            Icon,
            {
              name: "Flame",
              size: 10,
          ...
          canManageEditingTasks && /* @__PURE__ */ React.createElement("div", { className: "flex gap-1.5 mt-4 pt-3 border-t border-slate-100 dark:border-slate-800" }, prevStatus && /* @__PURE__ */ React.createElement(
            "button",
            {
              onClick: (e) => {
                e.stopPropagation();
...
var ManagementRoomView = ({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "h-full flex flex-col gap-4 fade-in" }, /* @__PURE__ */ React.createElement(
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "px-4 py-3 flex items-center justify-between border-b border-slate-200 dark:border-slate-800 shrink-0" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement(
        Icon,
        {
          name: col.icon,
          size: 13,
      ...
      /* @__PURE__ */ React.createElement("div", { className: "p-3 flex-1 overflow-y-auto space-y-3 custom-scroll" }, colTasks.length === 0 ? /* @__PURE__ */ React.createElement(EmptyState, { icon: "Inbox", text: "Vac\xEDo" }) : colTasks.map((task) => {
        ...
        return /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement("div", { className: "p-4 space-y-2.5" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between gap-2 min-h-[20px]" }, task.category ? /* @__PURE__ */ React.createElement(
            "span",
            {
              className: `text-[9px] font-black uppercase tracking-wider px-2 py-0.5 rounded border ${getMgmtCategoryColor(task.category)}`
            },
            task.category
          ) : /* @__PURE__ */ React.createElement("span", null), badge && col.id !== "cerrado" && /* @__PURE__ */ React.createElement(
            "span",
            {
            ...
            /* @__PURE__ */ React.createElement(
              Icon,
              {
                name: badge.tone === "red" ? "AlertTriangle" : "Clock",
                size: 9
              }
            ),
            badge.label
          )), /* @__PURE__ */ React.createElement("p", { className: "font-black text-slate-800 dark:text-white text-sm leading-snug" }, task.title), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1.5" }, member && /* @__PURE__ */ React.createElement("span", { className: "flex items-center gap-1 text-[10px] font-bold bg-violet-50 dark:bg-violet-500/10 text-violet-700 dark:text-violet-300 px-1.5 py-0.5 rounded border border-violet-100 dark:border-violet-500/20 max-w-[130px] truncate" }, /* @__PURE__ */ React.createElement(Icon, { name: "UserCircle2", size: 9 }), member.name), client && /* @__PURE__ */ React.createElement("span", { className: "flex items-center gap-1 text-[10px] font-bold bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-1.5 py-0.5 rounded border border-blue-100 dark:border-blue-800 max-w-[130px] truncate" }, /* @__PURE__ */ React.createElement(Icon, { name: "Briefcase", size: 9 }), client.name)), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement(
            Icon,
            {
              name: "CalendarDays",
              size: 10,
              className: isOverdue ? "text-red-400" : "text-slate-500 dark:text-slate-400"
            }
          ), /* @__PURE__ */ React.createElement(
            "span",
            {
            ...
            task.date,
            task.time ? ` \xB7 ${task.time}` : ""
          ), isOverdue && /* @__PURE__ */ React.createElement("span", { className: "text-[9px] font-black text-red-500 dark:text-red-400 uppercase tracking-wider" }, "Vencida")), task.notes && /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-slate-500 dark:text-slate-400 leading-snug line-clamp-2" }, task.notes)),
          /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between gap-1 px-3 py-2.5 border-t border-slate-100 dark:border-slate-800" }, prevStatus ? /* @__PURE__ */ React.createElement(
            "button",
            {
              onClick: (e) => {
                e.stopPropagation();
            ...
            /* @__PURE__ */ React.createElement(Icon, { name: "ChevronLeft", size: 11 }),
            " Volver a",
            " ",
            prevLabel
          ) : /* @__PURE__ */ React.createElement("span", null), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-0.5" }, /* @__PURE__ */ React.createElement(
            "button",
            {
              onClick: (e) => {
                e.stopPropagation();
            ...
            nextStatus === "cerrado" ? "Cerrar" : "Avanzar",
            " ",
            /* @__PURE__ */ React.createElement(
              Icon,
              {
                name: nextStatus === "cerrado" ? "Check" : "ChevronRight",
                size: 11
              }
            )
          )))
...
var TaskDetailModal = ({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "flex-1 flex flex-col lg:flex-row overflow-hidden min-h-0" }, /* @__PURE__ */ React.createElement("div", { className: "flex-1 min-w-0 overflow-y-auto custom-scroll bg-white dark:bg-slate-950" }, /* @__PURE__ */ React.createElement("div", { className: "max-w-3xl mx-auto px-5 md:px-8 pt-6 md:pt-7 pb-10" }, /* @__PURE__ */ React.createElement(
      ...
      ), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] font-black uppercase tracking-[0.16em] text-slate-500 dark:text-slate-400" }, "Actividad"), totalLoggedMs > 0 && /* @__PURE__ */ React.createElement("span", { className: "ml-auto text-xs font-bold text-emerald-600 dark:text-emerald-400 flex items-center gap-1" }, /* @__PURE__ */ React.createElement(Icon, { name: "Clock", size: 11 }), formatDuration(totalLoggedMs))), /* @__PURE__ */ React.createElement("div", { className: "flex gap-3 mb-6" }, /* @__PURE__ */ React.createElement("div", { className: "w-8 h-8 rounded-full bg-gradient-to-tr from-purple-500 to-indigo-500 flex items-center justify-center text-white font-black text-[10px] shrink-0" }, (currentUserProfile?.name || "U").slice(0, 2).toUpperCase()), /* @__PURE__ */ React.createElement("div", { className: "flex-1 relative" }, /* @__PURE__ */ React.createElement(
        "textarea",
        {
          ref: commentInputRef,
          value: commentText,
        ...
        return /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement("div", { className: "w-5 h-5 rounded-full bg-gradient-to-tr from-purple-500 to-indigo-500 flex items-center justify-center text-white font-black text-[8px] shrink-0" }, person.name.slice(0, 2).toUpperCase()),
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "p-6 overflow-y-auto custom-scroll" }, /* @__PURE__ */ React.createElement("form", { onSubmit, className: "space-y-4" }, ["event", "accountTask", "editingTask", "managementTask"].includes(
        ...
        /* @__PURE__ */ React.createElement("option", { value: "" }, "\u{1F4BC} Sin cliente (Tarea interna)"),
