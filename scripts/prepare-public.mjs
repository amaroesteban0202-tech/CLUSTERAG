...
copyIntoPublic('src/app/main.compiled.js');
copyIntoPublic('src/app/boot.js');
copyIntoPublic('src/app/assets');
copyIntoPublic('src/styles/tailwind.generated.css');
copyIntoPublic('src/styles/main.css');
